      ...
      <nav className="container py-4 flex item-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <Select>
              ...
              <SelectContent>
                <SelectItem value="cheeze-deglight">Cheeze Deglight</SelectItem>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            <span className="absolute -top-4 -right-5 h-6 w-6 flex item-center justify-center rounded-full bg-orange-600 font-bold text-white">
              3
            </span>
          </div>
          <div className="flex item-center gap-3 ml-7">
